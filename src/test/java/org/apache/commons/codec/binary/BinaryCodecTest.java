...
public class BinaryCodecTest {
    ...
    public void testEncodeByteArray() {
        // With a single raw binary
        byte[] bits = new byte[1];
        String lencoded = new String(instance.encode(bits));
        assertEquals("00000000", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0;
        lencoded = new String(instance.encode(bits));
        assertEquals("00000001", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1;
        lencoded = new String(instance.encode(bits));
        assertEquals("00000011", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1 | BIT_2;
        lencoded = new String(instance.encode(bits));
        assertEquals("00000111", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1 | BIT_2 | BIT_3;
        lencoded = new String(instance.encode(bits));
        assertEquals("00001111", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4;
        lencoded = new String(instance.encode(bits));
        assertEquals("00011111", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5;
        lencoded = new String(instance.encode(bits));
        assertEquals("00111111", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6;
        lencoded = new String(instance.encode(bits));
        assertEquals("01111111", lencoded);
        bits = new byte[1];
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("11111111", lencoded);
        // With a two raw binaries
        bits = new byte[2];
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000000000000", lencoded);
        bits = new byte[2];
        bits[0] = BIT_0;
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000000000001", lencoded);
        bits = new byte[2];
        bits[0] = BIT_0 | BIT_1;
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000000000011", lencoded);
        bits = new byte[2];
        bits[0] = BIT_0 | BIT_1 | BIT_2;
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000000000111", lencoded);
        bits = new byte[2];
        bits[0] = BIT_0 | BIT_1 | BIT_2 | BIT_3;
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000000001111", lencoded);
        bits = new byte[2];
        bits[0] = BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4;
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000000011111", lencoded);
        bits = new byte[2];
        bits[0] = BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5;
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000000111111", lencoded);
        bits = new byte[2];
        bits[0] = BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6;
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000001111111", lencoded);
        bits = new byte[2];
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000011111111", lencoded);
        // work on the other byte now
        bits = new byte[2];
        bits[1] = BIT_0;
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("0000000111111111", lencoded);
        bits = new byte[2];
        bits[1] = BIT_0 | BIT_1;
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("0000001111111111", lencoded);
        bits = new byte[2];
        bits[1] = BIT_0 | BIT_1 | BIT_2;
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("0000011111111111", lencoded);
        bits = new byte[2];
        bits[1] = BIT_0 | BIT_1 | BIT_2 | BIT_3;
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("0000111111111111", lencoded);
        bits = new byte[2];
        bits[1] = BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4;
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("0001111111111111", lencoded);
        bits = new byte[2];
        bits[1] = BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5;
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("0011111111111111", lencoded);
        bits = new byte[2];
        bits[1] = BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6;
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("0111111111111111", lencoded);
        bits = new byte[2];
        bits[0] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        bits[1] = (byte) (BIT_0 | BIT_1 | BIT_2 | BIT_3 | BIT_4 | BIT_5 | BIT_6 | BIT_7);
        lencoded = new String(instance.encode(bits));
        assertEquals("1111111111111111", lencoded);
    ...
    public void testEncodeObject() throws Exception {
        // With a single raw binary
        byte[] bits = new byte[1];
        String lencoded = new String((char[]) instance.encode((Object) bits));
        assertEquals("00000000", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0;
        lencoded = new String((char[]) instance.encode((Object) bits));
        assertEquals("00000001", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1;
        lencoded = new String((char[]) instance.encode((Object) bits));
    ...
    public void testToAsciiBytes() {
        // With a single raw binary
        byte[] bits = new byte[1];
        String lencoded = new String(BinaryCodec.toAsciiBytes(bits));
        assertEquals("00000000", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0;
        lencoded = new String(BinaryCodec.toAsciiBytes(bits));
        assertEquals("00000001", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1;
        lencoded = new String(BinaryCodec.toAsciiBytes(bits));
    ...
    public void testToAsciiChars() {
        // With a single raw binary
        byte[] bits = new byte[1];
        String lencoded = new String(BinaryCodec.toAsciiChars(bits));
        assertEquals("00000000", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0;
        lencoded = new String(BinaryCodec.toAsciiChars(bits));
        assertEquals("00000001", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1;
        lencoded = new String(BinaryCodec.toAsciiChars(bits));
    ...
    public void testToAsciiString() {
        // With a single raw binary
        byte[] bits = new byte[1];
        String lencoded = BinaryCodec.toAsciiString(bits);
        assertEquals("00000000", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0;
        lencoded = BinaryCodec.toAsciiString(bits);
        assertEquals("00000001", lencoded);
        bits = new byte[1];
        bits[0] = BIT_0 | BIT_1;
        lencoded = BinaryCodec.toAsciiString(bits);
